import {ERR_HASS_HOST_REQUIRED, ERR_INVALID_AUTH, ERR_INVALID_HTTPS_TO_HTTP} from 'home-assistant-js-websocket';
import {parseQuery} from 'home-assistant-js-websocket/dist/util';
...
export class Auth {
    ...
    get wsUrl() {
        // this is why we need the wrapper. Supervisor uses a different endppoint
        return 'ws://supervisor/core/websocket/api';
    }
